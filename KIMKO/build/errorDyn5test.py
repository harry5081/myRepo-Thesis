...
p_init=np.array([90,0,0]) # x, y, phi_p
v_init=np.array([130,0,0]) # vp, 0, wp
...
for i in range(window):
    ...
    obj=obj+err_cur @ Q @ err_cur.T# + demand_state_current[0]**2+demand_state_current[3]**2
    ...
    #obj=obj+err_next.T @ Q @ err_next + demand_state_current[0]**2+demand_state_current[3]**2
