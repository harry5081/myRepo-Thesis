...
v_ref=np.array([[0,1,0],[0,2,0],[0,3,0]])
p_ref=np.array([[5.504,32.72,0],[21.41,61.84,0],[45.97,84.15,0]])

print(np.reshape(v_ref,(-1,9)))
p_ref.reshape((3*3,1))
ref = np.concatenate((np.reshape(v_ref,(-1,9)),np.reshape(p_ref,(-1,9))),axis=0)
# print(ref)
# ref=ref.reshape((6,3))
# print(ref)
p=reshape(ref,18,1)
...
########################################################################################################
ref_state_temp = np.array([v_ref,p_ref])
ref_state = p
#########################################################################################################
